...
import { addNewAddress, Gender, NewAddressData } from "@/services/addresses";
import styles from "@/styles/components/Address/AddressAddModal.module.scss";
...
export default function AddressAddModal({
  ...
  t: Messages["ProfilePage"]["address"]["addModal"];
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<AddressAddFormData>();

  const mutation = useMutation((credentials: NewAddressData) =>
    addNewAddress(credentials)
  );
